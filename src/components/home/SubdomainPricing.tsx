...
const tiers = [
  { letters: "1 letter", example: "hashpo.com/s/a", price: "$2,000", icon: Crown, highlight: true },
  { letters: "2 letters", example: "hashpo.com/s/ab", price: "$1,500", icon: Star, highlight: false },
  { letters: "3 letters", example: "hashpo.com/s/abc", price: "$1,000", icon: Sparkles, highlight: false },
  { letters: "4 letters", example: "hashpo.com/s/abcd", price: "$500", icon: Globe, highlight: false },
];
