      ...
      <div className="relative z-10 max-w-[1080px] mx-auto px-6 py-20">
        ...
        <div className="mt-16 p-12 bg-[#0d0d14] border border-[#1e1e2e] rounded-2xl flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex gap-3 flex-wrap">
            <Link to="/site/edit" className="bg-[#ff4500] text-white px-7 py-3.5 font-extrabold text-sm rounded-xl hover:bg-[#ff5c1a] transition-all hover:-translate-y-0.5">
              Launch My Collection →
            </Link>
            <Link to="/marketplace" className="bg-transparent text-white border border-[#1e1e2e] px-7 py-3.5 font-bold text-sm rounded-xl hover:border-[#8888aa] transition-all">
              Browse NFTs
            </Link>
          </div>
        </div>
